...
static void generate_histogram_rgb(Histogram histogram, at_bitmap_type *image,
...
/*  This is pass 1  */
static void median_cut_pass1_rgb(QuantizeObj *quantobj, at_bitmap_type *image,
  const at_color *ignoreColor) 
{
...
static void median_cut_pass2_rgb(QuantizeObj *quantobj, at_bitmap_type *image,
...
void quantize(at_bitmap_type *image, long ncolors, const at_color *bgColor,
